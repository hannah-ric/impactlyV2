    ...
    <div className="space-y-xl animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        ...
        <div className="lg:col-span-2 space-y-lg">
              ...
              >
                ...
                <TabsContent value="list" className="animate-fade-in-up">
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p>
                      The list view of material topics will be available in the
                      next update.
                    </p>
                  </div>
                </TabsContent>

                <TabsContent value="comparison" className="animate-fade-in-up">
                  <div className="text-center py-12 text-muted-foreground">
                    <Info className="h-12 w-12 mx-auto mb-4 text-primary/50" />
                    <h3 className="text-lg font-medium mb-2">
          ...
          {showActionPlan && (
            <Card className="border-2 border-primary/10 shadow-md overflow-hidden animate-fade-in-up">
              <CardHeader className="bg-gradient-to-r from-primary/5 to-transparent pb-md">
                <div className="flex justify-between items-center">
                  <div>
